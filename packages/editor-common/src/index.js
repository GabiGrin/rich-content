...
export { FocusManager, RichContentModal, mergeStyles, normalizeInitialState,
  ComponentDataValidator, isValidUrl, isVideoUrl, normalizeUrl, getUrlMatches,
  startsWithHttps, hasProtocol, sizeClassName, alignmentClassName, textWrapClassName } from 'wix-rich-content-common';
